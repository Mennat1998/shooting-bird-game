...
{
    document.querySelector(".title h2").textContent+= `${localStorage.getItem('name')}`;
    document.querySelector(".content h3").textContent+= `${localStorage.getItem('name')}`;
    //selectors
...
for(let i=0 ; i<arraybirds.length;i++)
{
    ...
    console.log(Math.abs(arraybirds[i].top-rect.top),Math.abs(arraybirds[i].top-rect.top)<150);
    console.log(Math.abs(arraybirds[i].left-rect.left),Math.abs(arraybirds[i].left-rect.left)<150);
    if(Math.abs(arraybirds[i].left-rect.left)<200 && Math.abs(arraybirds[i].top-rect.top)<200 )
    {
        console.log("hey");
